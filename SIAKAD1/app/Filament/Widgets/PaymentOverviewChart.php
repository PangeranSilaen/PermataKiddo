...
class PaymentOverviewChart extends ChartWidget
{
    ...
    // Chart diperbarui setiap 15 menit
    protected static ?string $pollingInterval = '15m';
    
    // Set the column span to take half the width
    protected int | string | array $columnSpan = ['lg' => 1, 'xl' => 1];
    
    // Set sort order to make it appear at the bottom, after StatsOverview
    protected static ?int $sort = 20;
    
    // Kita tambahkan filter untuk melihat periode yang berbeda
