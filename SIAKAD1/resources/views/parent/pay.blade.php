...
@section('title', 'Pembayaran SPP - PermataKiddo')
...
<div class="header">
    ...
    <div>
        <a href="{{ url()->previous() }}" class="btn btn-outline btn-outline-primary">
...
<div class="row">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex align-items-center">
                                    <span class="payment-status-indicator {{ $payment->status == 'paid' ? 'payment-status-paid' : 'payment-status-pending' }}"></span>
    ...
    <div class="col-md-5">
        ...
        <div class="card animate-fade-in" style="animation-delay: 0.2s">
            ...
            <div class="card-body">
                <form method="POST" action="{{ route('parent.pay.confirm', $payment->id) }}" enctype="multipart/form-data">
                    @csrf
        ...
        <div class="card animate-fade-in" style="animation-delay: 0.2s">
            ...
            <div class="card-body text-center p-4">
                ...
                <p style="color: var(--text-light);">Tagihan untuk bulan {{ ucfirst($payment->month) }} telah lunas.</p>
                <a href="{{ route('parent.dashboard') }}" class="btn btn-primary mt-3">
